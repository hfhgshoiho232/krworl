        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center">
            <p className="mb-6 text-lg text-gray-700 leading-relaxed">
              Industrial Control Care assists users of industrial controls by maintaining systems through means of spares and repairs, whether current or obsolete. ICC aims to help operators reduce costs and avoid unnecessary upgrades by offering repairs for AC drive, DC drive, circuit board, invertors in addition to Industrial PC, CNC, CPU, PLC, VFD, HMI, and SMPS power supply repair services.
            </p>
